...
from core.stroy_generation import StoryGenerator
...
def create_story(
    ...
    # todo:add backgound tasks, generate story
...
def get_complete_story(story_id: int, db:Session = Depends(get_db)):
    ...
    complete_story = bulid_complete_story_tree(db, story)
    return complete_story

def bulid_complete_story_tree (db: Session, story:Story)-> CompleteStoryResponse:
